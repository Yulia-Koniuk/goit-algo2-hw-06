...
Таким чином, точний підрахунок оптимальний для невеликих даних, а HyperLogLog для великих наборів як ефективний компроміс між пам’яттю та часом обчислень.**
